  ...
  turk.submit = function(object) {
    ...
    for(var key in object) {
      if ((hopUndefined || object.hasOwnProperty(key)) && (typeof object[key] != "function") ) {
          var tmp_data = object[key];
          
          rawData[key] = tmp_data;
          addFormData(form, key, JSON.stringify(tmp_data));
      }
    }
      
      // Post to server!        
        $.post("https://web.stanford.edu/~nvelez/cgi-bin/swist_testers/submit_results.php",{expData: JSON.stringify(rawData)});
